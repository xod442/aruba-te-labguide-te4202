...
In this workshop, students will have the opportunity to two of these innovative switches as top of rack leafs, and an HPE Aruba Networking 6300 as a spine switch using Aruba Fabric Composer (AFC), a powerful API-driven, software-defined orchestration solution. Additionally, they will be able to deploy policies synchronized with the Pensando Policy Services Manager (PSM).  
